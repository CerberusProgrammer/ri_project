    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(default='pbkdf2_sha256$600000$oEv8bcKuBRYySXlzlLwJCd$z0xkPEC8pOaoM56KDHGg8TCYygzdVOL9AOAF/AdlSM0=', max_length=128)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iva_retenido', models.DecimalField(decimal_places=2, max_digits=2, null=True)),
                ('isr_retenido', models.DecimalField(decimal_places=2, max_digits=2, null=True)),
                ('dias_de_credito', models.CharField(max_length=100, null=True)),
                ('credito', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
