    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(default='pbkdf2_sha256$600000$KZnsaVuprYgFFNe6jUiW60$hEapvdytmRDJ43Mt//Yumu93QZYdZQI0sw0k5oWBZrs=', max_length=128)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('costo', models.DecimalField(decimal_places=2, max_digits=10)),
                ('divisa', models.CharField(default='MXN', max_length=5)),
                ('requisicion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ri_compras.requisicion')),
                ('servicio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ri_compras.servicio')),
            ],
        ),
        migrations.CreateModel(
            name='Recibo',
