    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(default='pbkdf2_sha256$600000$yK0u2WJVTFUCisxm5buTVc$w+ELBNSZKjkRDBUs1OhClrWVywl1LkwotVnsQe3PVvA=', max_length=128)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proveedor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='requisiciones_proyecto', to='ri_compras.proveedor')),
                ('proyecto', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='requisiciones_proyecto', to='ri_compras.project')),
                ('servicios', models.ManyToManyField(blank=True, to='ri_compras.serviciorequisicion')),
                ('usuario', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='requisiciones_proyecto', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordenado', models.BooleanField(default=False)),
                ('productos', models.ManyToManyField(blank=True, to='ri_compras.productorequisicion')),
                ('proveedor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='requisiciones_departamento', to='ri_compras.proveedor')),
                ('servicios', models.ManyToManyField(blank=True, to='ri_compras.serviciorequisicion')),
                ('usuario', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='requisiciones_departamento', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Recibo',
        ...
        migrations.AddField(
            model_name='ordendecompra',
            name='requisicion',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ri_compras.requisiciondepartamento'),
        ),
        migrations.AddField(
            model_name='ordendecompra',
            name='usuario',
        ...
        migrations.CreateModel(
            name='HistoricalRequisicionProyecto',
            fields=[
                ('id', models.BigIntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
            ...
            options={
                'verbose_name': 'historical requisicion proyecto',
                'verbose_name_plural': 'historical requisicion proyectos',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical requisicion departamento',
                'verbose_name_plural': 'historical requisicion departamentos',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('proveedor', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='ri_compras.proveedor')),
                ('requisicion', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='ri_compras.requisiciondepartamento')),
                ('usuario', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
